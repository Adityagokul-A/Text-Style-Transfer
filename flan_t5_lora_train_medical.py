...
# Ensure you have a file named "medical2.json" in the same directory
try:
    with open("medical2.json", "r", encoding="utf-8") as f:
        data = json.load(f)  # list of dicts with "medical_sentence" and "casual_sentence"
        print(f"Loaded {len(data)} examples from medical2.json")
except FileNotFoundError:
    print("Error: medical2.json not found. Please create this file with your dataset.")
    # Creating a dummy dataset for demonstration if the file doesn't exist
    data = [
        {"medical_sentence": "The patient presents with symptoms of pyrexia and cephalalgia.", "casual_sentence": "The patient has a fever and a headache."},
        {"medical_sentence": "A myocardial infarction was confirmed via electrocardiogram.", "casual_sentence": "A heart attack was confirmed with an EKG."}
    ]
...
output_dir = "./flan-t5-base-lora-style-transfer"
